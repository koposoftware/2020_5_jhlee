...
<body>
    ...
    <script src="/resources/assets/js/addEvent.js"></script>
    <script src="/resources/assets/js/editEvent.js"></script>
    <script src="/resources/assets/js/etcSetting.js"></script>
</body>
