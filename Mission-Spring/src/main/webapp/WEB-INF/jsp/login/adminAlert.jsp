...
<header>	
  ...
  <h1> <i class="icofont-support" style="font-size:60px"></i> 안녕하세요, ${ adminLoginVO.admin_name } 상담사님 </h1><br>
  </c:if>
  <c:if test="${ adminLoginVO.type eq 'B' }">
  <h1> <i class="icofont-support" style="font-size:60px"></i> 안녕하세요, ${ adminLoginVO.admin_name } 행원님 </h1><br>
  </c:if>
  <c:if test="${ adminLoginVO.type eq 'V' }">
  <h1> <i class="icofont-support" style="font-size:60px"></i> 안녕하세요, ${ adminLoginVO.admin_name } 상담사님 </h1><br>
  </c:if>
   <c:if test="${ adminLoginVO.type eq 'I' }">
  <h1> <i class="icofont-support" style="font-size:60px"></i> 안녕하세요, ${ adminLoginVO.admin_name } 상담사님 </h1><br>
  </c:if>
  ...
  <input type="button" class="btn btn-outline-secondary px-3 " onclick="goQNA()" style="height:100px; width:190px; margin-right:510px; font-size:30px!important; font-weight:580" value="문의 확인 ">
