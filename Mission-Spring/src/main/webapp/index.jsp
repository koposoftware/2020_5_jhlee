  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block"> 
          ...
          <li><a href="${ pageContext.request.contextPath }/board/write">마이페이지 </a></li>
          ...
          <li><a href="#contact">영업점찾기</a></li>
			...
			<c:choose>
				...
				<c:otherwise>
					...
					<c:if test="${ not empty adminLoginVO }">
					<a href="${ pageContext.request.contextPath }/admin/logout" class="appointment-btn scrollto">
					</c:if>
						로그아웃</a>
				</c:otherwise>
...
<!--     <section id="testimonials" class="testimonials">
   ...
   <!--  <section id="gallery" class="gallery">
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=a6e615362d7f97308d32aaa3e87c8816&libraries=clusterer"></script>
	<script>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        ...
        <div class="credits">
          ...
          Made by <a href="https://bootstrapmade.com/">ONEHANA</a>
        </div>
      </div>
