...
public class AdminController {
	...
	public ModelAndView login(AdminVO admin,
			HttpSession session) { /* @RequestParam("id")String id, @RequestParam("password")String password */
